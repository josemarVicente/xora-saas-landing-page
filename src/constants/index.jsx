export const features = [
  ...
  export const plans = [
    ...
    },
    {
      ...
      priceMonthly: 390,
      priceYearly: 290,
      caption: 'Exclusivo para equipas',
      features: [
        'Todas funcionalidades',
        'Armazenamento adicional de até 10TB',
        '50% de desconto por membro',
  ...
  export const testimonials = [
    ...
    {
      id: '1',
      name: 'Marques Erickson',
      role: 'Vid capital intl',
      avatarUrl: '/images/testimonials/mark-erixon.png',
      comment:
        "Fiquei desconfiado no início, mas agora não consigo imaginar as nossas operações sem ele. É muito impactante.",
    },
    {
      id: '2',
      name: 'Melanie Hurst',
    ...
    },
    {
      ...
      comment:
        'O aumento de eficiência é inegável. O Xora transformou o nosso fluxo de trabalho para sempre.',
    },
  ];
